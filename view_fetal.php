...
<body style="background-color: black;">
  ...
  $sql = "SELECT * FROM cal_fetal WHERE Code LIKE '%$code%'";
  ...
  echo "<table class='table table-striped table-dark'>
            ...
            <th class='lTd'>Heart Rate CH 2 <span style='opacity:0.4'>(bpm)</span></th>
            </tr>
            ";
  while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td class='lTd'>" . P1($row['S2_HR1_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td class='lTd'>" . P1($row['S2_HR2_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td class='lTd'>" . P1($row['S2_HR3_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td class='lTd'>" . P1($row['S2_HR4_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td class='lTd'>" . P1($row['S2_HR5_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr class='bTd'>";
    echo "<td></td>";
    ...
    echo "<td class='lTd'>" . P1($row['S2_HR6_Cal']) . "</td>";
    echo "</tr>";
