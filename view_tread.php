...
<body style="background-color: black;">
  ...
  $sql = "SELECT * FROM cal_tread WHERE Code LIKE '%$code%'";
  ...
  echo "<table class='table table-striped table-dark'>
            ...
            <th>Speed Read <span style='opacity:0.4'>(km/h)</span></th>         
            </tr>
            ";
  while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td>" . P3($row['S_Speed1_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    // Caldate
    ...
    echo "<td>" . P3($row['S_Speed2_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td>" . P3($row['S_Speed3_Cal']) . "</td>";
    echo "</>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td>" . P3($row['S_Speed4_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td>" . P3($row['S_Speed5_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr class='bTd'>";
    echo "<td></td>";
    echo "<td></td>";
    echo "<td></td>";
    echo "<td class='lTd'>" . P0($row['S_Speed6']) . "</td>";
    echo "<td>" . P3($row['S_Speed6_Cal']) . "</td>";
    echo "</tr>";
  }
