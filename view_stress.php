...
<body style="background-color: black;">
  ...
  $sql = "SELECT * FROM cal_stress WHERE Code LIKE '%$code%'";
  ...
  echo "<table class='table table-striped table-dark'>
            ...
            <th class='lTd'>Speed Set <span style='opacity:0.4'>(km/h)</span></th>
            <th class='lTd'>Speed Read <span style='opacity:0.4'>(km/h)</span></th>         
            </tr>
            ";
  while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td class='lTd'>" . P0($row['S_Speed1']) . "</td>";
    echo "<td class='lTd'>" . P3($row['S_Speed1_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    // Caldate
    ...
    echo "<td class='lTd'>" . P0($row['S_Speed2']) . "</td>";
    echo "<td class='lTd'>" . P3($row['S_Speed2_Cal']) . "</td>";
    echo "</tr>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td class='lTd'>" . P0($row['S_Speed3']) . "</td>";
    echo "<td class='lTd'>" . P3($row['S_Speed3_Cal']) . "</td>";
    echo "</>";
    // -------------------
    echo "<tr>";
    echo "<td></td>";
    ...
    echo "<td></td>";
    echo "<td></td>";
    echo "<td class='lTd'>" . P0($row['S_Speed5']) . "</td>";
    echo "<td class='lTd'>" . P3($row['S_Speed5_Cal']) . "</td>";
    echo "</tr>";;
  }
  echo "</table>";
